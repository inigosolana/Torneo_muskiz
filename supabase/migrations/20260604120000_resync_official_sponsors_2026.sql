...
INSERT INTO public.sponsors (name, logo_url, tier, website_url)
SELECT 'Texmo', '/patrocinadores/texmo.png', 'Gold', 'https://www.texmoindustrial.com/'
WHERE NOT EXISTS (SELECT 1 FROM public.sponsors WHERE name = 'Texmo');

INSERT INTO public.sponsors (name, logo_url, tier, website_url)
SELECT 'Pan Menesa', '/patrocinadores/pan-menesa.png', 'Gold', NULL
WHERE NOT EXISTS (SELECT 1 FROM public.sponsors WHERE name = 'Pan Menesa');
...
UPDATE public.sponsors SET logo_url = '/patrocinadores/texmo.png', tier = 'Gold', website_url = 'https://www.texmoindustrial.com/' WHERE name = 'Texmo';
UPDATE public.sponsors SET logo_url = '/patrocinadores/pan-menesa.png', tier = 'Gold' WHERE name = 'Pan Menesa';

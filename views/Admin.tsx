...
export const Admin: React.FC<AdminProps> = ({ onUpdateTeam, onUpdateMatches, onUpdateLimits }) => {
    ...
    useEffect(() => {
        ...
        if (sundayDraft) {
            const patched = patchDraft(sundayDraft, patchSundaySimulationDraft);
            if (patched) {
                nextDrafts = nextDrafts.map((d) =>
                    d.id === sundayDraft.id ? { ...d, matches: patched } : d
                );
                anyChanged = true;
            }
        }
                                            ...
                                            <tbody className="divide-y divide-slate-100">
                                                ...
                                                standings.map((team, index) => (
                                                        ...
                                                        >
                                                            ...
                                                            <td className="px-2 py-4 text-center font-black text-lg text-slate-900">
                                                                {team.points}
                                                            </td>
